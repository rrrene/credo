    ...
    expected =
      if Version.match?(System.version(), ">= 1.14.0-dev") do
        [
          ...
          {:alias, {1, 11, 'Credo'}, :Credo},
          {:., {1, 16, nil}},
          {:alias, {1, 17, 'Sample'}, :Sample},
          {:do, {1, 24, nil}},
          {:eol, {1, 26, 1}},
          {:at_op, {2, 3, nil}, :@},
          {:identifier, {2, 4, 'test_attribute'}, :test_attribute},
          {:atom, {2, 19, 'foo'}, :foo},
          {:eol, {2, 23, 2}},
          {:identifier, {4, 3, 'def'}, :def},
          {:paren_identifier, {4, 7, 'foobar'}, :foobar},
          {:"(", {4, 13, nil}},
          {:identifier, {4, 14, 'parameter'}, :parameter},
          {:")", {4, 23, nil}},
          {:do, {4, 25, nil}},
          {:eol, {4, 27, 1}},
          {:alias, {5, 5, 'String'}, :String},
          {:., {5, 11, nil}},
          {:paren_identifier, {5, 12, 'split'}, :split},
          {:"(", {5, 17, nil}},
          {:identifier, {5, 18, 'parameter'}, :parameter},
          {:")", {5, 27, nil}},
          {:dual_op, {5, 29, nil}, :+},
          {:identifier, {5, 31, 'parameter'}, :parameter},
          {:eol, {5, 40, 1}},
          {:end, {6, 3, nil}},
          {:eol, {6, 6, 2}},
          {:identifier, {8, 3, 'defmodule'}, :defmodule},
          {:alias, {8, 13, 'InlineModule'}, :InlineModule},
          {:do, {8, 26, nil}},
          {:eol, {8, 28, 1}},
          {:identifier, {9, 5, 'def'}, :def},
          {:paren_identifier, {9, 9, 'foobar'}, :foobar},
          {:"(", {9, 15, nil}},
          {:identifier, {9, 16, 'v'}, :v},
          {:")", {9, 17, nil}},
          {:when_op, {9, 19, nil}, :when},
          {:paren_identifier, {9, 24, 'is_atom'}, :is_atom},
          {:"(", {9, 31, nil}},
          {:identifier, {9, 32, 'v'}, :v},
          {:")", {9, 33, nil}},
          {:do, {9, 35, nil}},
          ...
          {:"}", {10, 11, nil}},
          {:match_op, {10, 13, nil}, :=},
          {:alias, {10, 15, 'File'}, :File},
          {:., {10, 19, nil}},
          {:identifier, {10, 20, 'read'}, :read},
          {:eol, {10, 24, 1}},
          {:end, {11, 5, nil}},
          {:eol, {11, 8, 1}},
          {:end, {12, 3, nil}},
    ...
    expected =
      if Version.match?(System.version(), ">= 1.14.0-dev") do
        [
          ...
          {:do, {1, 24, nil}},
          {:eol, {1, 26, 1}},
          {:identifier, {2, 3, 'defmodule'}, :defmodule},
          {:alias, {2, 13, 'InlineModule'}, :InlineModule},
          {:do, {2, 26, nil}},
          {:eol, {2, 28, 1}},
          {:identifier, {3, 5, 'def'}, :def},
          {:paren_identifier, {3, 9, 'foobar'}, :foobar},
          {:"(", {3, 15, nil}},
          {:identifier, {3, 16, 'x'}, :x},
          {:")", {3, 17, nil}},
          {:do, {3, 19, nil}},
          ...
          {:identifier, {4, 7, 'x'}, :x},
          {:match_op, {4, 9, nil}, :=},
          {:paren_identifier, {4, 11, 'f'}, :f},
          {:"(", {4, 12, nil}},
          {:paren_identifier, {4, 13, 'g'}, :g},
          {:"(", {4, 14, nil}},
          {:paren_identifier, {4, 15, 'h'}, :h},
          {:"(", {4, 16, nil}},
          {:identifier, {4, 17, 'a'}, :a},
          {:")", {4, 18, nil}},
          {:",", {4, 19, 0}},
          ...
          {:")", {4, 22, nil}},
          {:",", {4, 23, 0}},
          {:paren_identifier, {4, 25, 'k'}, :k},
          {:"(", {4, 26, nil}},
          {:paren_identifier, {4, 27, 'i'}, :i},
          {:"(", {4, 28, nil}},
          {:identifier, {4, 29, 'c'}, :c},
          {:dual_op, {4, 30, nil}, :-},
          {:int, {4, 31, 1}, '1'},
