defmodule Credo.Check.Consistency.MultiAlias do
  @moduledoc """
  ...
  @collector Credo.Check.Consistency.MultiAlias.Collector
  ...
  defp message_for(:multi = _expected) do
    "Most of the time you are using the multi-alias, but here you are using multiple single directives"
  end

  defp message_for(:single = _expected) do
    "Most of the time you are using the multiple single line alias but here you are using the multi-alias syntax"
  end
end
