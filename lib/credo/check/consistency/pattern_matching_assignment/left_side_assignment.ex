defmodule Credo.Check.Consistency.PatternMatchingAssignment.LeftSideAssignment do
  use Credo.Check.CodePattern

  def property_value, do: :left_side
  ...
  defp parse_def({:=, [line: line_no], [{_, _, _}, argument]} = node, property_values, filename) when is_atom(argument) do
