defmodule Credo.Check.Consistency.MultiRequire do
  @moduledoc """
  ...
  or use one multi instruction per namespace:
    ...
    require Ecto.{Query, Schema, Multi}
  ...
  @collector Credo.Check.Consistency.MultiRequire.Collector
  ...
  defp message_for(:multi = _expected) do
    "Most of the time you are using the multi-require, but here you are using multiple single directives"
  end

  defp message_for(:single = _expected) do
    "Most of the time you are using the multiple single line require but here you are using the multi-require syntax"
  end
end
