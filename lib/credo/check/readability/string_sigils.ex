defmodule Credo.Check.Readability.StringSigils do
  @moduledoc """
  If you used quoted strings that contain quotes, you might want to consider switching to the
  use of sigils instead. That allows you to remove the noise that results from the fact
  that you need to escape quotes within quotes.
  """
